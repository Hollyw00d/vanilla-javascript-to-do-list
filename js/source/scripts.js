...
(() => {
    ...
    class ToDoListOperations {
      ...
      constructor() {
        ...
        // To do item check box
        this.toDoItemCheckbox = document.querySelector('.to-do-list-checkbox')
     ...
     addToDoItem = (e) => {
       ...
       const editInstructions = '<p id="instructions"><strong>Click on an item to edit it.</strong></p>'
       
       // If array contains elements and
       // document.body does NOT contain #instructions
       // insert instructions
       if(this.toDoListItems.length > 0 && !document.body.contains(document.getElementById('instructions'))) {
          this.list.insertAdjacentHTML('afterend', editInstructions)
       }
